...
-   Probleme
    ...
    -   „Paradox der Aggregtion" (Notwendige Ergänzung: Grundlegende Interessen jedes Einzelnen)
...
-   Staatliche Belastungen und Begünstigungen sollen so ausgerichtet sein, dass das Ausmaß der Ungleichheit verringert wird.

-   (Diskussion: Begründung?)

## Horizontale Gerechtigkeit

-   Individuen in ethisch relevanter gleicher Position sollen sich auch nach staatlicher Behandlung in ethisch vergleichbarer Position befinden\
    $\rightarrow$ Schutz vor willkürlicher Diskriminierung

-   Begrenzung für Maßnahmen der vertikalen Gerechtigkeit: Durch staatliche Maßnahmen (zur Herstellung vertikaler Gerechtigket) soll es nicht zu einer Rangfolgenumkehr der Nutzenpositionen kommen, es sei denn, die ursprüngliche Rangfolge war ungerecht.
...
Lesen wir etwas: <https://ourworldindata.org/global-economic-inequality>
