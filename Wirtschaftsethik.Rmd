...
## Effizienz und Gerechtigkeit in der Klimaschutzpolitik{-}
...
## Stellungnahme des Deutschen Ethikrats zur Klimagerechtigkeit {-}
...
qr <- qr_code('https://www.ethikrat.org/fileadmin/Publikationen/Stellungnahmen/deutsch/klimagerechtigkeit.pdf')
plot(qr)

```

1. Bitte lesen Sie zunächst insb. den Abschnitt 2.7 zu den Grundlagen der Klimaethik.
...
2. Lesen Sie nun bitte insbesondere die Abschnitte 3.1 bis 3.3.
...
* **Moralische Standards:**
  * Gelten für Personen, die sieautonom anerkennen
...
1. Materielle Grundsicherung

1. Aktive Beschäftigungspolitik

1. Soziales Gesundheitswesen
